...
urlpatterns = [
    ...
    path('/save_template/<str:name>/<str:key>', views.save_template,
            name='dashboard_save_template'),
    path('/load/<str:name>', views.load, name='dashboard_load'),
    path('/load/<str:name>/<str:val>', views.load_template,
            name='dashboard_load_template'),
    path('/load_template/<str:name>/<str:val>', views.load_template,
            name='dashboard_load_template'),
    ...
    path('/delete_template/<str:name>', views.delete_template,
    ...
    path('/<str:name>/<str:val>', views.template,
