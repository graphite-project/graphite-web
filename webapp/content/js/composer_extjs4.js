...
{
  windowpathname=windowpathname.slice(5)
}
var RENDER_BASE_URL = window.location.protocol + "//" + window.location.host +windowpathname;//window.location.pathname//
...
GraphiteComposer.prototype = {
  ...
  loadURL: function (url) {
    ...
    this.url.setParam('width', this.window.body.getWidth(true));
    this.url.setParam('height', this.window.body.getHeight(true));
