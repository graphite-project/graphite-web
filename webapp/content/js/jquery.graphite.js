            ...
            graph.find('#newmetric').each(function () {
                ...
                edit.keydown(function(e) {
                    if(e.which===13) { // on enter
                        ...
                        var new_row = $('<tr class="metricrow"><td><a href=#><span class="metricName">'+edit.val()+'</span></a></td><td><a href=#><span class="yaxis">one</span></a></td><td class="killrow"><img src="../content/img/delete.png"></td></tr>');
                            setup_row(new_row);
