...
### Bug Fixes
 - Fix #871: Adjust aggregator-rules input_pattern match greediness to support numeric matching after captured field (#872)
 - Another test fix try (#874)
 - Fixing tests for S390 (#880)
 - Trying to fix tests (#881)
 - Fix the manhole for Twisted > 16 and Python 3 (#882)
 - Fix missing encoding for line protocol (#885) 

### Features / Enhancements
 - s390x support for travis (#869)
